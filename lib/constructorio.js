...
ConstructorIO.prototype = {
  ...
  /**
   * @description Adds synonym group
   */
  ...
  /**
   * @description Modifies synonym group
   */
  ...
  /**
   * @description Retrieves synonym group for specified id or phrase
   */
  getSynonymGroup(params, callback) {
    const json = clonedeep(params);
    const { group_id, phrase } = json;
    const { num_results_per_page, page } = params;
    const qsParams = {};
    delete json.group_id;
    delete json.phrase;
  ...
  /**
   * @description Retrieves synonym groups
   */
  ...
  /**
   * @description Removes synonym group for specified id
   */
  ...
  /**
   * @description Removes all synonym groups
   */
