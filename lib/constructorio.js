...
ConstructorIO.prototype = {
  ...
  /**
   * @description Adds an item group to your index.
   */
  addItemGroup(params, callback) {
    request({
      method: 'POST',
   ...
   */
  addOrUpdateItemGroupsBatch(params, callback) {
    request({
      method: 'PATCH',
      url: this.makeUrl('item_groups'),
      auth: this.makeAuthToken(),
  ...
  /**
   * @description Removes an item group from your index.
   */
  removeItemGroup(params, callback) {
    request({
      method: 'DELETE',
      url: this.makeUrl('item_groups'),
      auth: this.makeAuthToken(),
