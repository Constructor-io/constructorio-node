...
declare class Catalog {
    ...
    retrieveVariations(
        ...
        networkParameters?: NetworkParameters
    ): Promise<{ variations: Variation[], total_count: number, [key: string]: any }>;
    ...
    getItemGroup(
        ...
        networkParameters?: NetworkParameters
    ): Promise<{ item_groups: ItemGroup[], total_count: number; [key: string]: any; }>;

    getItemGroups(networkParameters?: NetworkParameters): Promise<{ item_groups: ItemGroup[], total_count: number; [key: string]: any }>;
    ...
    removeItemGroups(networkParameters?: NetworkParameters): Promise<{ message: string }>;
